# Deployment & Monitoring oraz Krytyczna retrospekcja
...
print("\n" + "="*80 + "\n")
print(critical_retrospection)

# Zapisanie do pliku
with open('deployment_monitoring_risks.md', 'w', encoding='utf-8') as f:
    f.write(deployment_monitoring + "\n\n" + critical_retrospection)

print(f"\n✅ Deployment, monitoring i analiza ryzyk zapisane do 'deployment_monitoring_risks.md'")