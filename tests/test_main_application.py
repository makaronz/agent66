...
class TestMainApplication:
    ...
    def test_load_config_success(self, mock_config):
        ...
        with patch('main.load_secure_config') as mock_load:
    ...
    async def test_main_async_config_validation_failure(self):
        ...
        with patch('main.load_config', return_value=mock_config), \
             patch('main.validate_config', return_value=(False, ["error"], [])):
    ...
    async def test_main_async_service_initialization_failure(self, mock_config):
        ...
        with patch('main.load_config', return_value=mock_config), \
             ...
             patch('main.MarketDataProcessor', side_effect=Exception("Init failed")):
